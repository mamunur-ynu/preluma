...
.team-hero {
    ...
    background: linear-gradient(135deg, #020617, #111827 48%, #4c1d95);
    margin-bottom: 22px;
}
.team-hero img {
    position:absolute;
...
.member-card.lead {
    ...
    background:linear-gradient(135deg, rgba(14,165,233,.16), rgba(124,58,237,.13));
}
.member-role {
    color:#93c5fd;
    font-weight:900;
...
def project_team_page():
    st.markdown("### Project Team")
    if TEAM_PHOTO:
        st.markdown(f"""
        <div class='team-hero'>
            <img src='{TEAM_PHOTO}' alt='Team Preluma'>
    ...
    <div class='member-grid'>
        <div class='member-card'>
            ...
            <h3>MD FAHIM</h3>
            <p>Supported the interactive feature logic by checking quiz behavior, testing user flow, and giving feedback to make the learning experience more interesting.</p>
            <ul class='contribution-list'>
                <li>Quiz behavior checking</li>
        ...
        <div class='member-card lead'>
            ...
            <ul class='contribution-list'>
                <li>Main Python Streamlit app development</li>
                <li>UI/UX design and premium interface polish</li>
                <li>Core module integration and deployment</li>
                <li>Wikipedia real-data and Smart QnA upgrade</li>
                <li>Final demo flow and presentation preparation</li>
            </ul>
        </div>
        <div class='member-card'>
            <div class='member-role'>Topic Data • Documentation</div>
            <h3>MD JIARUL ISLAM</h3>
            <p>Supported topic data organization, content preparation, documentation, and presentation material so the project looks complete and academic.</p>
            <ul class='contribution-list'>
                <li>Topic data support</li>
